...
# =============================================================================
# Python Volume Distance Calculator (run via 'python MRC_Distance_Calculator.py') 
...
dataDir = os.path.join(parDir, 'Datasets/2_Volumes_1D') #location of all MRCs (i.e., entire state space)
...
if 1: #save to file
    np.save('Dist_SS1_Volumes.npy', D)
