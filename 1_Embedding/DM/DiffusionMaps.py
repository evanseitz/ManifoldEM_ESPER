...
# PARAMETERS: The optimal 'eps' variable must first be discovered via the...
#   ...'Method to estimate optimal epsilon' section below. Before running...
#   ...in batch mode, make sure 'eps' is first correct (as detailed in our...
#   ...paper); this value should be correct for all PDs in that same dataset
