...
#   ...conformational motions. This procedure should be skipped if dealing with...
#   ...datasets generated with n=1 degree of freedom, which will be automated...
#   ...in a future version by assessment of R2 scores in non-leading eigenvectors.
#   As detailed in our MS, additional modifications must be made to...
#   ...properly handle the scenario of n>2 degrees of freedom.
#   Example DM outputs have been provided in the 'Data_Manifolds_126' folder...
#   ...within this directory for your experimental use, which were calculated from...
#   ....images on half of a great circle (126 PDs) in SS_2 (2 CMs) with each...
#   ...image generated with CTF=[5k,15k], SNR=0.1 and tau=5.
